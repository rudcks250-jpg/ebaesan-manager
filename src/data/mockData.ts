...
export const seedVendors: Vendor[] = [
  ...
  },
  {
    ...
    type: 'quantity',
    items: [
      { id: 'item_pork_belly', name: '삼겹살', unit: '박스', defaultQty: 5 },
      { id: 'item_pork_neck', name: '목살', unit: '박스', defaultQty: 3 },
      { id: 'item_pork_jowl', name: '항정살', unit: '박스', defaultQty: 2 },
      { id: 'item_pork_skin', name: '껍데기', unit: '박스', defaultQty: 1 },
    ],
    createdAt: now,
    updatedAt: now,
  },

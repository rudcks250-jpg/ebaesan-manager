...
const JIWOO_FOOD_STANDARDS: Readonly<Record<string, { name: string; specification: string }>> = {
  ...
  '애호박(주키니)': { name: '애호박(주키니)', specification: '개' },
  쥬키니: { name: '애호박(주키니)', specification: '개' },
  ...
  '청양고추(3kg)': { name: '청양고추(3kg)', specification: '3kg' },
  고추: { name: '청양고추(3kg)', specification: '3kg' },
